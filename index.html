...
<head>
    ...
    <title>Desenvolvedor Web - Walter</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Walter</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills">Desenvolvedor Web - Graphic Artist - User Experience Designer</span>
                    </div>
                </div>
            </div>
        </div>
